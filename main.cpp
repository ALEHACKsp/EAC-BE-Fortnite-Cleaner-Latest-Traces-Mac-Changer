...
int main()
{
    ...
    SetConsoleTitleA("Fortnite Cleaner | 09/01/2022");
    Printa.Title("\n\n    Welcome to Fortnite Cleaner\n\n", 12);

	Sleep(1000);
    Printa.Loading("Loading...\n");

	const int clean_ans = MessageBox(NULL, XorString("Do you want clean ?"), XorString("Fortnite Cleaner"), MB_YESNO);
	switch (clean_ans)
	{
	case IDYES:
		Cleaner();
	...
	{
		printf("\n");
		Printa.OK("Cleaned succesfully !\n");
	}
	else
	{
		Printa.Fail("Not cleaned !");
	}

	const int mac_ans = MessageBox(NULL, XorString("Do you want change mac ?"), XorString("Fortnite Cleaner"), MB_YESNO);
	switch (mac_ans)
	{
	case IDYES:
		Mac_Changer();
	...
	{
		Printa.Fail("Mac not spoof !");
	}

	const int check_ans = MessageBox(NULL, XorString("Do you want check ?"), XorString("Fortnite Cleaner"), MB_YESNO);
	switch (check_ans)
	{
	case IDYES:
		Checker();
